...
-- ALTER VIEW biwelozew3.ext_wlz_vw_terceiros_AX  WITH ENCRYPTION AS

/* Removidos os clientes. Devem ser carregados apenas os fornecedores
SELECT 
...
FROM CUSTTABLE C
	...
	LEFT JOIN DIRPARTYPOSTALADDRESSVIEW ENDERECO ON ENDERECO.PARTY = C.PARTY AND VALIDFROM <= GETDATE() AND VALIDTO >= GETDATE()
WHERE P.ORGNUMBER <> '' AND P.ORGNUMBER IS NOT NULL
AND C.DATAAREAID = 'WELO'
