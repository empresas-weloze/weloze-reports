...
ALTER FUNCTION [biwelozew3].[_faturasEmAtraso] (@CodigoFornecedor VARCHAR(20), @Periodo DATE)
RETURNS TABLE AS
	...
	RETURN (
		...
		FROM PURCHTABLE P	
			...
			CROSS APPLY BiUtil.DataFiltroAnoMes(P.CREATEDDATETIME) AS DATAMESANO
