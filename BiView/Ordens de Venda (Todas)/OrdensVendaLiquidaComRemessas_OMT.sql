...
-- ALTER VIEW [BiView].[OrdensVendaLiquidaComRemessas_OMT]  AS 
...
FROM SALESTABLE S	
	...
	OUTER APPLY BiUtilDimensaoFinanceira(S.DEFAULTDIMENSION, 'ESTABELECIMENTO') AS ESTABELECIMENTO
	...
	CROSS APPLY BiUtilDataFiltroAnoMes(S.CREATEDDATETIME) AS DATAMESANO
...
WHERE L.DATAAREAID	= 'OMT' AND L.SALESQTY != 0
