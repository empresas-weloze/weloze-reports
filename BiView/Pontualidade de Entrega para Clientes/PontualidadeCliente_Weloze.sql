...
-- ALTER VIEW BiView.PontualidadeCliente_Weloze  AS
...
WHERE ST.DATAAREAID = 'WELO'
	...
	AND (( 
		...
		AND OT.OPERATIONTYPEID NOT IN (
			...
			OR (OT.DATAAREAID = 'WELO' AND OT.OPERATIONTYPEID = 'S5902/5124' AND CFOP.CFOPID = '5.124') -- operação especial Master
