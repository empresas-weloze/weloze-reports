...
-- ALTER VIEW [BiView].[ReceitaLiquida_HIST_Delav]  AS
...
(
	...
	FROM SALESCOMPLEMENTARYINVOICEHEADER SCIH 
		...
		OUTER APPLY BiUtil.ImpostoPorGrupos (SCIL.DATAAREAID, SCIL.TAXGROUP, SCIL.TAXITEMGROUP, 8, SCIL.AMOUNT) AS IIPI
		OUTER APPLY BiUtil.ImpostoPorGrupos (SCIL.DATAAREAID, SCIL.TAXGROUP, SCIL.TAXITEMGROUP, 1, SCIL.AMOUNT) AS IPIS
		OUTER APPLY BiUtil.ImpostoPorGrupos (SCIL.DATAAREAID, SCIL.TAXGROUP, SCIL.TAXITEMGROUP, 2, SCIL.AMOUNT) AS IICMS
		OUTER APPLY BiUtil.ImpostoPorGrupos (SCIL.DATAAREAID, SCIL.TAXGROUP, SCIL.TAXITEMGROUP, 15, SCIL.AMOUNT) AS IICMSDIF
		OUTER APPLY BiUtil.ImpostoPorGrupos (SCIL.DATAAREAID, SCIL.TAXGROUP, SCIL.TAXITEMGROUP, 3, SCIL.AMOUNT) AS ICOFINS

		OUTER APPLY BiUtil.CategoriaDelav(ERP.RECID) AS CATEGORIA
