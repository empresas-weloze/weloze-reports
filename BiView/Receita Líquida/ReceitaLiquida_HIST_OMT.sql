...
SELECT 
	...
	X.FATOR * (X.VALORLINHA + X.IPI ) AS "Valor Fat. Bruto s/ Encargos",
	...
	X.FATOR * (X.VALORLINHA + X.ENCARGOS - X.PIS - X.ICMS - X.COFINS - X.ISSQN) AS "Valor Rec. Líquida"
...
(
	...
	FROM FISCALDOCUMENT_BR NF
		...
		CROSS APPLY BiUtil.CategoriaWeloze(P.RECID) AS CATEGORIA
	...
	WHERE 1=1 
		...
		AND NF.STATUS = 1 
		AND NF.DIRECTION = 1
		AND OT.OPERATIONTYPEID IN ('S5124/5125', 'S5101 001', 'S5122/6122', '56101 001', 'S7101/7127', 'SSUCATAS', 'S5101', 'S5118', 'S5124/S5125', 'S6116', 'S6101', 'S6118', 'S6122', 'S6124/6125', 'S5501/6501', 
		'F116', 'S7101/7127', 'S5116', 'S6116', 'S5551/6551', 'S101/102', 'S107/108', 'S501', 'S118', 'S5102', 'S5551/6551', 'S933')
	...
	WHERE 1=1 
		...
		AND NF.DIRECTION = 1
		AND LNF.DATAAREAID = 'OMT'
		AND OT.OPERATIONTYPEID IN ('E1201/2201', 'DV1201/2201', 'E201/202', 'E1201/2201', 'E3201')
		AND OT.CREATEFINANCIALTRANS = 1 
) AS X
