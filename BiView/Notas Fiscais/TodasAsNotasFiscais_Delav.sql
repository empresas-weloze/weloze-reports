...
-- ALTER VIEW BiView.TodasNotasFiscais_Delav AS
...
SELECT
	...
	TERCEIRO.CITY				AS "CIDADE - TERCEIRO",
	ENTREGA.STATE				AS "ESTADO - ENTREGA",
	ENTREGA.CITY				AS "CIDADE - ENTREGA",
	ESTABEL.STATE				AS "ESTADO - FILIAL",
	ESTABEL.CITY				AS "CIDADE - FILIAÇ",
...
WHERE NF.DATAAREAID = 'DELA' AND NF.STATUS = 1

UNION

SELECT * FROM DAX_Weloze_HIST.BiView.TodasNotasFiscais_Delav_HIST