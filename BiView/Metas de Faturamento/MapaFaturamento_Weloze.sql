...
SELECT 
	...
	WHERE CG.RECID IS NOT NULL OR X.CODIGOCLIENTE NOT IN (SELECT CUSTACCOUNT FROM CUSTGOALLINES CGL JOIN CUSTGOAL CG ON CG.RECID = CGL.CUSTGOAL AND CG.YEAR = X.ANO)
