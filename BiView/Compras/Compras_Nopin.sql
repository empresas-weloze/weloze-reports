...
-- ALTER VIEW [BiView].[Compras_Nopin]  AS
...
(
	...
	FROM FISCALDOCUMENT_BR NF
		...
		CROSS APPLY BiUtil.CategoriaNopin (PR.RECID) AS CATEGORIA
	...
	WHERE L.JOURNALNAME != 'CTRC' 
		...
		AND L.DATAAREAID = 'NBRA' AND T.TRANSDATE >= '2017-01-01'
		--AND L.DATAAREAID = 'WELO' AND T.TRANSDATE >= '2016-01-01'
