		...
		(
			...
			FROM FISCALDOCUMENT_BR NF
				...
				JOIN CUSTTABLE CT ON 
						(V.CNPJCPFNUM_BR =	'' AND V.ACCOUNTNUM		= CT.VENDACCOUNT AND V.DATAAREAID = CT.DATAAREAID) -- Terceiros do Exterior
					OR	(V.CNPJCPFNUM_BR <> '' AND CT.CNPJCPFNUM_BR = V.CNPJCPFNUM_BR AND V.DATAAREAID = CT.DATAAREAID)
